...
<body>
  <div class="wrap">
    <header class="appbar">
      <div class="brand">
        ...
        <div>
          ...
          <p class="lead">Preencha os dados para editar o usuário</p>
        </div>
      </div>
    ...
    <main class="card">
      <form class="row" action="processa_edicao.php" method="POST" id="cadForm" novalidate>
        <input type="hidden" name="id" value="<?php echo htmlspecialchars($id); ?>" />

        <div>
          <label for="name">Nome</label>
          <input type="text" id="name" name="name" required maxlength="100" autocomplete="name" value="<?php echo htmlspecialchars($user['name']); ?>" />
        </div>

        <div>
          <label for="email">Email</label>
          <input type="email" id="email" name="email" required maxlength="150" autocomplete="email" value="<?php echo htmlspecialchars($user['email']); ?>" />
        </div>
